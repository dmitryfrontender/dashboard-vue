<template>
    <aside id="aside" class="fixed-to-top">
        <div class="menu-control justify-sb flex-container align-center">
            <div class="logo">
                <RouterLink to="/">
...
export default {
    ...
    methods: {
        toggleMenu() {
            ...
            body.classList.toggle('_mobileSidebar')
        }
    }
}
</script>
...
<style lang="scss">
#aside .aside-menu ul li.active a,
